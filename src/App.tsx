...
import { CameraIcon, ChevronDownIcon, ClearIcon, EnhanceIcon, LandscapeIcon, PortraitIcon, UploadIcon, VideoIcon, SpinnerIcon, DownloadIcon } from './components/icons';
...
export default function App() {
    // FIX: Removed API key state management to follow security best practices. API key should be handled via environment variables.
    ...
    const handleEnhancePrompt = useCallback(async () => {
        ...
        setError(null);
        try {
            // FIX: Removed API key from function call. It's now handled by the service.
            const enhanced = await enhancePrompt(prompt);
            setPrompt(enhanced);
        } catch (e: any) {
            setError(e.message || t('enhanceError'));
        } finally {
    ...
    const handleGeneration = async () => {
        ...
        try {
            ...
            setError(e.message || t('generationError'));
        } finally {
            setIsLoading(false);
        }
    };
                    ...
                    <div className={`relative p-1 bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 rounded-xl shadow-2xl ${isLoading ? 'animate-border-chase' : ''}`}>
                        <div className="relative bg-[#2b2d31] p-8 rounded-lg">
                           ...
                           {isLoading && <LoadingOverlay message={loadingMessage} t={t} />}
                            ...
                            {/* FIX: Removed ApiKeyInput component to adhere to security guidelines. */}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
                                <div className="space-y-6">
                                    <PromptInput 
                                        ...
                                        // FIX: Enhance button is no longer disabled based on API key presence.
                                        isDisabled={false}
                                        t={t}
                                    />
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="pt-6">
                                         <button 
                                            ...
                                            // FIX: Generate button is no longer disabled based on API key presence.
